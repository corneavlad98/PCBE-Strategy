...
public class MyConstants {
    ...
    public static final int TIME_TO_COLLECT_ROCK = 15;
    public static final int AMOUNT_OF_ROCK = 15;

    public static final int TIME_TO_COLLECT_GOLD = 20;
    public static final int AMOUNT_OF_GOLD = 10;
